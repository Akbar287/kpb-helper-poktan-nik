                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" tabindex="1" autofocus>
                                        @error('email')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center text-center mt-5">
                                            Belum ada Akun ?  
                                            <a type="button" href="{{ route('register') }}" class="mx-2">
                                                {{ __('Registrasi') }}
                                            </a>
                                        </div>
